...
def primeraCreacion(numeroJugadores):   
    if numeroJugadores == 6:
        ...
        "Jaboneros", "Mafalda", "Vox", "Galerna",  "Cariñoso","Miguelito",  "Torrole", "Merlo", 
        ...
        c2 = ["Cariñoso", "Cocodrilo", "Tomillo", "Pitu", "Hicosol", "Jumanji", "Malafama", "Rincon", "Victoria", "Wahaha", "Leoni", "Malagueta", "Playa", "Ambata", "Echevarria", "Espigon", "Cerrado", "Jaboneros", "4 esquinas", "Presentacion", "San Anton", "SEK", "BBVA", "Delgado"]
        c5 = ["Asuncion"]
        ...
        for hexag, hexData in estado.items():
            recurso = hexData["recurso"]
            if recurso == "Trigo":
                trigo += 1 
            elif recurso == "Piedra":
                piedra += 1
                ...
                metal += 1
        print("Celdas con trigo:", trigo)
        print("Celdas con piedra:", piedra)
        print("Celdas con madera:", madera)
        print("Celdas con metal:", metal)
        print("Ciudades:", 91 - trigo - madera - piedra - metal)
