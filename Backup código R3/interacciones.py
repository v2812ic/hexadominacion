            ...
            if accion in acciones[jugador]: # Comprueba si decide realizarla
                ...
                # Accion de mover              
                    ...
                    for movimiento in accionesJugador:
                        ...
                        if estado[origen]["propietario"] == jugador and estado[destino]["propietario"] == jugador:
                            ...
                            print(f"{jugador} ha movido {moverReal} soldados desde {origen} hacia {destino}.")
                             ...
                             print(f"{jugador} no puede mover soldados desde {origen} hacia {destino}. Las instrucciones no son correctas.")
    ...
    for territorio, datosTerritorio in estado.items():
        ...
        if propietario in jugadores:
            if recurso != "Ciudad" and recurso != "Capital":
                ...
                if nivel == 1:
                    recibe = random.randint(2, 4)
                elif nivel == 2:
                    recibe = random.randint(3, 6)
                elif nivel == 3:
                    recibe = random.randint(5, 9)
                elif nivel == 4:
